...
from core.project import Clip, Track, CropRegion, Project, SourceInfo
...
from app.project_restore_mixin import ProjectRestoreMixin
...
class MainWindow(AudioFlowMixin, ProjectRestoreMixin, QMainWindow):
    """主窗口，管理录制/预览/导出的生命周期"""
