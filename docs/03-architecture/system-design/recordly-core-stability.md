...
**日期:** 2026-07-16
**状态:** Draft
**来源:** PRD `docs/01-product/prd/recordly-core-stability.md` + 审查报告 `docs/archive/review/core-architecture-interaction-review-2026-07-16.md`
**Parent Issue:** #27
...
详见 `docs/archive/dev/out-of-scope.md`。
