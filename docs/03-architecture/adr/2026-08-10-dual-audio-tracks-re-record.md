...
**日期：** 2026-08-10
**状态：** Accepted
**关联：** Flow #125 / `docs/03-architecture/system-design/recordly-dual-audio-tracks-and-re-record.md` / `docs/01-product/prd/recordly-dual-audio-tracks-and-re-record.md`
...
- `docs/03-architecture/adr/006-data-persistence-json.md`：本轮不新增持久化字段，遵循原子保存与 schema 校验约定。
