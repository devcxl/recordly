...
## 技术方案参考
- docs/01-product/prd/recordly-core-stability.md
- docs/03-architecture/system-design/recordly-core-stability.md
- docs/archive/design/recordly-core-stability-task-graph.md
- docs/03-architecture/adr/007-project-session-recording-export-controllers.md
