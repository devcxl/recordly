...
- 技术方案：`docs/03-architecture/system-design/recordly-playhead-click-behavior.md` §3.1、§3.3
- ADR：`docs/03-architecture/adr/2026-07-19-playhead-click-behavior.md` 决策 2、决策 4
