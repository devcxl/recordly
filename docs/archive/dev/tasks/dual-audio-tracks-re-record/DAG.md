...
- Parent Issue: #125
- PRD: `docs/01-product/prd/recordly-dual-audio-tracks-and-re-record.md`
- Spec: `docs/03-architecture/system-design/recordly-dual-audio-tracks-and-re-record.md`
- ADR: `docs/03-architecture/adr/2026-08-10-dual-audio-tracks-re-record.md`
