...
**关联：** Parent Issue #105、`docs/03-architecture/system-design/recordly-editor-usability-fixes.md`、`docs/03-architecture/adr/2026-07-19-editor-shortcut-registry.md`
